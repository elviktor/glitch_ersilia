 ...
 * Mountain component.
 */
AFRAME.registerComponent('mountainwire', {
  schema: {
  ...
  update: function () {
    ...
    // Create mesh.
    var mesh = new THREE.Mesh(geometry, new THREE.MeshPhongMaterial({map: texture, wireframe: true}));
 ...
 * <a-mountain>
 */
AFRAME.registerPrimitive('a-mountainwire', {
  defaultComponents: {
    mountain: {}
  },

  mappings: {
    color: 'mountainwire.color',
    'shadow-color': 'mountainwire.shadowColor',
    'sun-position': 'mountainwire.sunPosition',
    'world-depth' :'mountainwire.worldDepth',
    'world-width' :'mountainwire.worldWidth'
  }
});